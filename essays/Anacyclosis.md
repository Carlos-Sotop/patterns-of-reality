...
2) Tyranny (monarchy turns corrypt)
3) Aristrocacy (rule by the best, just)
4) Oligarchy (aristrocracy turns corrupt)
...
One key marker in the emergence of a new governing order always involves:
- a mission (shared goal), or
- a threat (shared enemy), or
- both (the strongest formula)

With time, and as that mission is accomplised or that threat is neutralized, the unifying narrative begins to fade, and without a cohesive narrative, citizens lose purpose, and different power factions begin to form among the elite. This is the so called original seed of self-destruction unfolding, the group unites on a common goal, but once that common goal has already been accomplised the collapse of the group begins.
